          ...
          Obx(() => IconButton(
            icon: Container(
              ...
              decoration: BoxDecoration(
                color: controller.isDevMode.value ? Get.find<ThemeController>().primaryColor.value : Colors.transparent,
                   ...
                   ? Container(
                       ...
                       child: IntrinsicHeight(
                         child: Row(
                           ...
                           children: [
                             Icon(Icons.developer_mode, color: Get.find<ThemeController>().primaryColor.value, size: 16),
                             const SizedBox(width: 8),
                             Expanded(
                               child: Text(
          ...
          children: [
            ...
            if (logType == 'DEV') ...[
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: Get.find<ThemeController>().primaryColor.value.withOpacity(0.2),
