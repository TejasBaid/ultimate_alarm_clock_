...
class AddOrUpdateAlarmController extends GetxController {
  ...
  final isMemoryEnabled = false.obs;
  final numMemoryRounds = 3.obs;
                ...
                ? Row(
                    ...
                    children: [
                      TextButton(
                        style: ButtonStyle(
                          backgroundColor:
                              MaterialStateProperty.all(Get.find<ThemeController>().primaryColor.value),
                        ),
                        child: Text(
                          'Save',
  ...
  void onInit() async {
    ...
    if (Get.arguments != null || homeController.isProfile.value) {
      ...
      isMemoryEnabled.value = alarmRecord.value.isMemoryEnabled;
      numMemoryRounds.value = alarmRecord.value.numMemoryRounds;
    ...
    initialValues.addAll({
      ...
      'isMemoryEnabled': isMemoryEnabled.value,
      'numMemoryRounds': numMemoryRounds.value,
  ...
  void addListeners() {
    ...
    setupListener<bool>(isMemoryEnabled, 'isMemoryEnabled');
    setupListener<int>(numMemoryRounds, 'numMemoryRounds');
