...
class AscendingVolumeTile extends StatelessWidget {
          ...
          Row(
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  color: (iconColor ?? Get.find<ThemeController>().primaryColor.value).withOpacity(0.1),
                  borderRadius: BorderRadius.circular(10),
                ),
                child: Icon(
                  icon,
                  color: iconColor ?? Get.find<ThemeController>().primaryColor.value,
                  size: 22,
                ),
              ),
              const SizedBox(width: 16),
  ...
  Widget _buildPreviewSection(BuildContext context) {
    return Container(
      padding: const EdgeInsets.all(20),
      decoration: BoxDecoration(
        color: Get.find<ThemeController>().primaryColor.value.withOpacity(0.06),
        borderRadius: BorderRadius.circular(16),
        border: Border.all(
