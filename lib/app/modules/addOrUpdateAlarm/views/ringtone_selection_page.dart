...
class RingtoneSelectionPage extends GetView<AddOrUpdateAlarmController> {
          ...
          children: [
            ...
            OutlinedButton.icon(
              ...
              style: OutlinedButton.styleFrom(
                side: BorderSide(color: Get.find<ThemeController>().primaryColor.value),
  ...
  Widget _buildRingtoneListItem({
    ...
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(
        color: isSelected
            ? Get.find<ThemeController>().primaryColor.value.withOpacity(0.08)
                    ...
                    Container(
                      ...
                      child: IconButton(
                        ...
                        icon: Icon(
                          ...
                          color: isSelected 
                              ? (isPlaying ? Colors.red : Get.find<ThemeController>().primaryColor.value)
                              : themeController.primaryDisabledTextColor.value,
                          size: 28,
                        ),
                        tooltip: isSelected 
